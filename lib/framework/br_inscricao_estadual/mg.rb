module BrInscricaoEstadual
  class MG < Common
    ...
    def digit_verify
      digito1 = calculate_digito1(insc_est)
      return false unless insc_est[-2].to_i == digito1 # [0,1].include?(digito1) &&

      digito2 = calculate_digito2(insc_est)
      return false unless insc_est[-1].to_i == digito2
